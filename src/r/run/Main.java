...
/**
 * r.run.Main program for the application ContactBook.
 */
public class Main {
    ...
    /**
     * r.run.Main program. Runs the command interpreter.
    ...
    private static void getPhone(Scanner in, ContactBook cBook) {
        ...
        name = in.nextLine();
        try {
            System.out.println(String.valueOf(cBook.getPhone(name)));
        } catch (ContactDoesNotExistException e) {
            System.out.println(e.getMessage());
        }
    }
